  ...
  "opening-call": [
    {
      ...
      title: "Listen to the Midnight Legend",
      badge: "Invitation",
      sceneTag: "opening-call",
      lineStart: 1,
      lineEnd: 6,
      location: "The Story Opens at Midnight",
      scenePrompt: "The poem begins like a storyteller leaning close. First the child should feel invited into an important secret.",
      narration: "The opening is not action yet. It is an invitation. Longfellow wants the child to lean in and feel that a legendary night is about to begin.",
      significance: "This matters because the poem first builds attention and wonder before it teaches the plan.",
      actions: [
        ...
        { id: "feel-midnight", label: "Feel the midnight hush", copy: "Notice how the night becomes part of the legend.", resultTitle: "The night itself becomes part of the invitation.", resultCopy: "The poem wants the child to feel that this is not an ordinary evening. Midnight makes the story feel big and memorable.", x: 68, y: 42, w: 176, requires: ["hear-invitation"] },
      ],
    },
    {
      id: "opening-call-scene-2",
      title: "Lock in the Lantern Plan",
      badge: "Signal Plan",
      sceneTag: "opening-call",
      lineStart: 7,
      lineEnd: 14,
      location: "Moonlit Boston and the Secret Signal",
      scenePrompt: "Now the poem explains the code that will matter later. This scene should feel like learning the secret plan.",
      narration: "These lines explain the lantern signal clearly. The child should come away knowing that one light means land and two means sea.",
      significance: "This matters because the whole ride depends on a shared signal. Without the plan, there is no warning system.",
      actions: [
        { id: "study-signal", label: "Study the lantern code", copy: "Notice the one-by-land, two-by-sea signal.", resultTitle: "The code becomes the key to the whole poem.", resultCopy: "This is the mission rule everything else depends on later in the night.", x: 31, y: 68, w: 182, requires: [] },
        { id: "send-friend", label: "Send the trusted friend", copy: "Feel how the plan depends on teamwork.", resultTitle: "The warning is already a team effort.", resultCopy: "One person rides, but another must watch, signal, and help the message travel.", x: 72, y: 46, w: 180, requires: ["study-signal"] },
      ],
    },
    {
      id: "opening-call-scene-3",
      title: "Cross the Moonlit Water",
      badge: "Harbor Crossing",
      sceneTag: "somerset-watch",
      lineStart: 15,
      lineEnd: 19,
      location: "Boston Harbor Under the Moon",
      scenePrompt: "The poem leaves planning behind and slips onto the water. This should feel quiet, secret, and careful.",
      narration: "The rowboat and muffled oars make the harbor scene feel stealthy. It is the sound of people trying not to be noticed.",
      significance: "This matters because the warning depends on hidden movement and careful watching before anyone raises the alarm.",
      actions: [
        ...
        { id: "watch-moon-track", label: "Watch the moon on the water", copy: "Feel how still and secret the harbor is.", resultTitle: "Quiet water makes the danger feel bigger.", resultCopy: "The calm moonlit harbor makes every hidden movement feel more serious.", x: 72, y: 48, w: 176, requires: ["cross-water"] },
      ],
    },
    {
      id: "opening-call-scene-4",
      title: "Face the Somerset",
      badge: "Threat",
      sceneTag: "somerset-watch",
      lineStart: 20,
      lineEnd: 23,
      location: "The Dark Warship in the Tide",
      scenePrompt: "Now the threat becomes visible. The harbor is no longer only quiet and pretty. It holds the enemy ship.",
      narration: "The Somerset changes the whole feeling of the scene. The ship is dark, heavy, and waiting in the tide like a warning all by itself.",
      significance: "This matters because the child can now see why the signal and the ride are needed at all.",
      actions: [
        { id: "spot-somerset", label: "Spot the Somerset", copy: "See the huge dark ship waiting in the tide.", resultTitle: "The threat becomes visible in the harbor.", resultCopy: "The huge black ship makes the danger feel real, not imagined.", x: 61, y: 56, w: 182, requires: [] },
        { id: "hold-the-threat", label: "Hold the danger in view", copy: "Let the warship change the mood of the poem.", resultTitle: "The harbor stops feeling safe.", resultCopy: "Once the Somerset is in view, the child understands that the warning is not just dramatic language. It is necessary.", x: 76, y: 40, w: 176, requires: ["spot-somerset"] },
      ],
    },
  ],
  "gathering-night": [
